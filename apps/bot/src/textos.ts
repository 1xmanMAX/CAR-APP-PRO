...
export const textos = {
  ...
  ayuda: [
    ...
    "📷 Foto de una boleta, un texto («grifo 350») o una nota de voz: lo leo y te pido confirmar antes de guardarlo",
  ...
  cancelado: "Cancelado.",
  sinFlujo: "Envíame el PDF de la guía del remitente, la foto de una boleta (o escribe el gasto: «grifo 350»), o /ayuda.",
